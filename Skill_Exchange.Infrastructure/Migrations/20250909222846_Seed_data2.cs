    ...
    public partial class Seed_data2 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RatingsAndFeedbacks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RatingsAndFeedbacks_Users_FromUserId",
                        column: x => x.FromUserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RatingsAndFeedbacks_Users_ToUserId",
                        column: x => x.ToUserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "[ParticipantAId] IS NOT NULL AND [ParticipantBId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RatingsAndFeedbacks_CreatedAt",
                table: "RatingsAndFeedbacks",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_RatingsAndFeedbacks_FromUserId",
                table: "RatingsAndFeedbacks",
                column: "FromUserId");

            migrationBuilder.CreateIndex(
                name: "IX_RatingsAndFeedbacks_ToUserId",
                table: "RatingsAndFeedbacks",
                column: "ToUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Requests_SenderId_RecieverId",
                table: "Requests",
